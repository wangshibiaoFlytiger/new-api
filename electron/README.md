# XzModel Electron Desktop App

This directory contains the Electron wrapper for XzModel, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
- **Production**:
  - macOS: `~/Library/Application Support/XzModel/data/`
  - Windows: `%APPDATA%/XzModel/data/`
  - Linux: `~/.config/XzModel/data/`
